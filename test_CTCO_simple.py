...
import pickle
from agents import COCT_simple
...
if __name__ == '__main__':
    ...
    for e in range(num_ep):
        ...
        while True :
            ...
            agent.RB.notify(s=S.detach().numpy(), sp=sp, r=R, done=done,
                        z=z.detach().numpy(), 
            ...
            if agent.total_steps % param['save_interval'] == 0:
                agent.save_actor(filename='{}/{}/model/{}_{}.model'.format(result_path,config_name, run_ID, agent.total_steps))
